local function options(panel)
    ...
    panel:NumSlider("Target switch delay", "cl_deadeye_target_delay", 0, 2, 2)
    panel:ControlHelp("Wait for the given seconds before switching to a different aim point")
